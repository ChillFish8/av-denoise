// Generated from ONNX "models/rt_ldr_small.onnx" by burn-onnx
use burn::prelude::*;
...
impl<B: Backend> Default for Model<B> {
    fn default() -> Self {
        Self::from_file("./src/model/rt_ldr_small.bpk", &Default::default())
    }
}
...
impl<B: Backend> Model<B> {
    ...
    pub fn new(device: &B::Device) -> Self {
        ...
        let resize2 = burn::nn::interpolate::Interpolate2dConfig::new()
            ...
            .with_align_corners(false)
            .init();
        let conv2d10 = Conv2dConfig::new([96, 64], [3, 3])
            .with_stride([1, 1])
            .with_padding(PaddingConfig2d::Explicit(1, 1, 1, 1))
            .with_dilation([1, 1])
            .with_groups(1)
        ...
        let resize3 = burn::nn::interpolate::Interpolate2dConfig::new()
            ...
            .with_align_corners(false)
            .init();
        let conv2d12 = Conv2dConfig::new([96, 64], [3, 3])
            .with_stride([1, 1])
            .with_padding(PaddingConfig2d::Explicit(1, 1, 1, 1))
            .with_dilation([1, 1])
            .with_groups(1)
        ...
        let resize4 = burn::nn::interpolate::Interpolate2dConfig::new()
            ...
            .with_align_corners(false)
            .init();
        let conv2d14 = Conv2dConfig::new([35, 32], [3, 3])
            .with_stride([1, 1])
            .with_padding(PaddingConfig2d::Explicit(1, 1, 1, 1))
            .with_dilation([1, 1])
            .with_groups(1)
