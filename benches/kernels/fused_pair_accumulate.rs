use av_denoise::nlmeans::kernels::nlm_fused_pair_accumulate;
...
pub struct FusedPairBench<R: Runtime> {
    pub client: ComputeClient<R>,
    pub ch: u32,
    pub ch_name: &'static str,
}

impl<R: Runtime> Benchmark for FusedPairBench<R> {
    type Input = FusedPairInput;
    type Output = ();
    ...
    fn name(&self) -> String {
        format!("fused_pair_accumulate_1080p_{}", self.ch_name)
    }
    fn sync(&self) {
